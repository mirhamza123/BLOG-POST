...
var require_stringify = __commonJS({
  "node_modules/qs/lib/stringify.js"(exports, module) {
    ...
    var stringify = function stringify2(object, prefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, encoder, filter2, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, sideChannel, depth, currentDepth) {
      ...
      if (allowEmptyArrays && isArray3(obj) && obj.length === 0 && Object.keys(obj).length === 0) {
...
var MaxDepthExceededError = (
  /** @class */
  function(_super) {
    __extends(MaxDepthExceededError2, _super);
    function MaxDepthExceededError2(maxDepth) {
      var _this = _super.call(this, "Maximum copy depth of " + String(maxDepth) + " exceeded; the value copied is nested too deeply.") || this;
      if (setPrototypeOf) {
        setPrototypeOf(_this, MaxDepthExceededError2.prototype);
      }
      _this.maxDepth = maxDepth;
      _this.name = "MaxDepthExceededError";
      return _this;
    }
    return MaxDepthExceededError2;
  }(RangeError)
);
var LegacyCache = (
  /** @class */
...
var propertyIsEnumerable2 = _a.propertyIsEnumerable;
...
function createCopier(options) {
  ...
  var copyArray = tagSpecificCopiers.Array, copyObject = tagSpecificCopiers.Object;
  var maxDepth = normalizedOptions.maxDepth;
...
var e = (e2, t2) => () => (t2 || (e2((t2 = { exports: {} }).exports, t2), e2 = null), t2.exports);
var t = {
  0: 8203,
  1: 8204,
  2: 8205,
...
function o(e2) {
  let t2 = JSON.stringify(e2), n2 = new TextEncoder().encode(t2), a = "";
  for (let e3 = 0; e3 < n2.length; e3++) {
    let t3 = n2[e3];
    a += r[t3 >> 6 & 3] + r[t3 >> 4 & 3] + r[t3 >> 2 & 3] + r[t3 & 3];
  }
  return i + a;
}
function s(e2) {
  return !Number.isNaN(Number(e2)) || /[a-z]/i.test(e2) && !/\d+(?:[-:\/]\d+){2}(?:T\d+(?:[-:\/]\d+){1,2}(\.\d+)?Z?)?/.test(e2) ? false : !!Date.parse(e2);
}
function c(e2) {
  try {
    new URL(e2, e2.startsWith("/") ? "https://acme.com" : void 0);
  } catch (e3) {
    return false;
  }
  return true;
}
function l(e2, t2, n2 = "auto") {
  return n2 === true || n2 === "auto" && (s(e2) || c(e2)) ? e2 : `${e2}${o(t2)}`;
}
var u = Object.fromEntries(Object.entries(r).map((e2) => [e2[1], +e2[0]]));
var d = Object.fromEntries(Object.entries(t).map((e2) => e2.reverse()));
var f = `${Object.values(t).map((e2) => `\\u{${e2.toString(16)}}`).join("")}`;
var p = RegExp(`[${f}]{4,}`, "gu");
function v(e2, t2) {
  return l(e2, t2);
}
var S = e((e2, t2) => {
  var n2 = Object.prototype.hasOwnProperty, r2 = Object.prototype.toString;
  t2.exports = function(e3, t3, i2) {
    if (r2.call(t3) !== "[object Function]") throw TypeError("iterator must be a function");
    var a = e3.length;
    if (a === +a) for (var o2 = 0; o2 < a; o2++) t3.call(i2, e3[o2], o2, e3);
    else for (var s2 in e3) n2.call(e3, s2) && t3.call(i2, e3[s2], s2, e3);
  };
});
var C = e((e2, t2) => {
  var n2 = S();
  ...
  function r2(e3, t3, n3) {
    if (arguments.length === 3) return r2.set(e3, t3, n3);
    if (arguments.length === 2) return r2.get(e3, t3);
    var i2 = r2.bind(r2, e3);
    for (var a in r2) r2.hasOwnProperty(a) && (i2[a] = r2[a].bind(i2, e3));
    return i2;
  }
  r2.get = function(e3, t3) {
    for (var n3 = Array.isArray(t3) ? t3 : r2.parse(t3), i2 = 0; i2 < n3.length; ++i2) {
      var a = n3[i2];
      if (!(typeof e3 == "object" && a in e3)) throw Error("Invalid reference token: " + a);
      e3 = e3[a];
    }
    return e3;
  }, r2.set = function(e3, t3, n3) {
    var i2 = Array.isArray(t3) ? t3 : r2.parse(t3), a = i2[0];
    if (i2.length === 0) throw Error("Can not set the root object");
    for (var o2 = 0; o2 < i2.length - 1; ++o2) {
      var s2 = i2[o2];
      typeof s2 != "string" && typeof s2 != "number" && (s2 = String(s2)), !(s2 === "__proto__" || s2 === "constructor" || s2 === "prototype") && (s2 === "-" && Array.isArray(e3) && (s2 = e3.length), a = i2[o2 + 1], s2 in e3 || (a.match(/^(\d+|-)$/) ? e3[s2] = [] : e3[s2] = {}), e3 = e3[s2]);
    }
    return a === "-" && Array.isArray(e3) && (a = e3.length), e3[a] = n3, this;
  }, r2.remove = function(e3, t3) {
    var n3 = Array.isArray(t3) ? t3 : r2.parse(t3), i2 = n3[n3.length - 1];
    if (i2 === void 0) throw Error('Invalid JSON pointer for remove: "' + t3 + '"');
    var a = r2.get(e3, n3.slice(0, -1));
    if (Array.isArray(a)) {
      var o2 = +i2;
      if (i2 === "" && isNaN(o2)) throw Error('Invalid array index: "' + i2 + '"');
      Array.prototype.splice.call(a, o2, 1);
    } else delete a[i2];
  }, r2.dict = function(e3, t3) {
    var n3 = {};
    return r2.walk(e3, function(e4, t4) {
      n3[t4] = e4;
    }, t3), n3;
  }, r2.walk = function(e3, t3, i2) {
    var a = [];
    i2 = i2 || function(e4) {
      var t4 = Object.prototype.toString.call(e4);
      return t4 === "[object Object]" || t4 === "[object Array]";
    }, function e4(o2) {
      n2(o2, function(n3, o3) {
        a.push(String(o3)), i2(n3) ? e4(n3) : t3(n3, r2.compile(a)), a.pop();
      });
    }(e3);
  }, r2.has = function(e3, t3) {
    try {
      r2.get(e3, t3);
    } catch (e4) {
      return false;
    ...
    return true;
  }, r2.escape = function(e3) {
    return e3.toString().replace(/~/g, "~0").replace(/\//g, "~1");
  }, r2.unescape = function(e3) {
    return e3.replace(/~1/g, "/").replace(/~0/g, "~");
  }, r2.parse = function(e3) {
    if (e3 === "") return [];
    if (e3.charAt(0) !== "/") throw Error("Invalid JSON pointer: " + e3);
    return e3.substring(1).split(/\//).map(r2.unescape);
  }, r2.compile = function(e3) {
    return e3.length === 0 ? "" : "/" + e3.map(r2.escape).join("/");
  };
})();
var w = ({ pointer: e2, mappings: t2, data: n2, hiddenStrings: r2 }) => {
  let i2 = t2[e2];
  if (i2) {
    delete t2[e2];
    let a = E(n2, e2);
    for (let e3 of a) t2[e3] = i2, (0, C.set)(n2, e3, v((0, C.get)(n2, e3), r2));
  } else {
    let t3 = E(n2, e2);
    for (let e3 of t3) (0, C.set)(n2, e3, v((0, C.get)(n2, e3), r2));
  }
};
function T(e2) {
  return "content" in e2 && !!e2.content;
}
var E = (e2, t2 = "") => {
  let n2 = [], r2 = (0, C.get)(e2, t2);
  if (T(r2)) for (let i2 = 0; i2 < r2.content.length; i2++) r2.content[i2].nodeType === "text" ? n2.push(`${t2}/content/${i2}/value`) : n2.push(...E(e2, `${t2}/content/${i2}`));
  return n2;
};
var D = ({ entityId: e2, entityType: t2, space: n2, environment: r2, field: i2, locale: a, editorInterface: o2, fieldType: s2, targetOrigin: c2, platform: l2 }) => {
  let u2 = {
    origin: "contentful.com",
    href: `${`${c2 || "https://app.contentful.com"}/spaces/${n2}/environments/${r2}`}/${t2 === "Entry" ? "entries" : "assets"}/${e2}/?focusedField=${i2}&focusedLocale=${a}&source=vercel-content-link`,
    contentful: {
      editorInterface: o2,
      fieldType: s2
    }
  };
  return l2 === "vercel" && delete u2.contentful, u2;
};
var O = (e2) => [
  "builtin",
  "sidebar-builtin",
...
var j = A.map((e2) => e2.replace(/_([a-z])/g, (e3, t2) => t2.toUpperCase()));
var M = [...A, ...j];
var N = (e2) => M.includes(e2);
function P(e2) {
  if (typeof structuredClone == "function") return structuredClone(e2);
  try {
    return JSON.parse(JSON.stringify(e2));
  } catch (t2) {
    return console.warn("Failed to clone data:", e2, t2), e2;
  }
}
var F = [
  "singleLine",
...
function I(e2, t2, n2, r2, i2, a, o2) {
  let s2 = o2 ? t2[o2] : t2;
  switch (e2) {
    case "Symbol":
      (0, C.set)(r2, i2, v(s2, n2));
      break;
    case "Text":
      (0, C.set)(r2, i2, v(s2, n2));
      break;
    case "RichText":
      ...
      break;
    case "Array":
      (0, C.set)(r2, i2, s2.map((e3) => typeof e3 == "string" ? v(e3, n2) : e3));
      break;
  }
}
var R = (e2, t2, n2, r2, i2) => {
  if (!e2.fields) return;
  let { contentSourceMaps: a } = e2.sys;
  if (!a) return;
  let { mappings: o2 } = a;
  for (let a2 in o2) {
    let { source: s2 } = o2[a2], c2 = e2.sys.space.sys.id, l2 = e2.sys.environment.sys.id, u2 = e2.sys.id, d2 = e2.sys.type, f2 = t2[s2.fieldType], p2 = n2[s2.editorInterface];
    if (O(p2.widgetNamespace) && !k(p2.widgetId)) continue;
    let m = a2.startsWith("/") ? a2 : `/${a2}`;
    if ((0, C.has)(e2, m)) {
      let t3 = (0, C.get)(e2, m);
      if (t3 === null) return;
      let n3 = m.split("/").pop();
      ...
      a3 ? I(f2, t3, D({
        ...
        targetOrigin: r2,
        platform: i2
      }), e2, m, o2) : Object.keys(t3).forEach((a4) => {
        let s3 = D({
          entityId: u2,
          entityType: d2,
          space: c2,
...
var z = (e2, t2, n2) => {
  let r2 = P(e2);
  if (r2.sys && "items" in r2) {
    var i2;
    let e3 = r2;
    if (!((i2 = e3.sys) != null && i2.contentSourceMapsLookup)) return e3;
    let { contentSourceMapsLookup: { fieldTypes: a, editorInterfaces: o2 } } = e3.sys, { items: s2, includes: c2 } = e3;
    s2.forEach((e4) => R(e4, a, o2, t2, n2)), c2 && c2.Entry && c2.Entry.forEach((e4) => R(e4, a, o2, t2, n2)), c2 && c2.Asset && c2.Asset.forEach((e4) => R(e4, a, o2, t2, n2));
  } else {
    let e3 = r2;
    if (!e3.sys.contentSourceMapsLookup) return console.error("Content source maps lookup data is missing"), e3;
    R(e3, e3.sys.contentSourceMapsLookup.fieldTypes, e3.sys.contentSourceMapsLookup.editorInterfaces, t2, n2);
  }
  return r2;
};
...
var getIdsFromUrn = function getIdsFromUrn2(urn) {
  ...
  var _urn$match = urn.match(regExp), _urn$match2 = _slicedToArray(_urn$match, 4), _ = _urn$match2[0], spaceId = _urn$match2[1], _urn$match2$ = _urn$match2[2], environmentId = _urn$match2$ === void 0 ? "master" : _urn$match2$, entryId = _urn$match2[3];
  return {
    spaceId,
    environmentId,
    entryId
...
var resolveResponse = function resolveResponse2(response, options) {
  ...
  var allIncludes = Object.keys(responseClone.includes || {}).reduce(function(all3, type) {
    return [].concat(_toConsumableArray(all3), _toConsumableArray(responseClone.includes[type]));
  }, []);
...
function createContentfulApi({ http, getGlobalOptions }, options) {
  ...
  async function internalGetEntries(query, options2) {
    const { withoutLinkResolution, withoutUnresolvableLinks, withLocaleBasedPublishing } = options2;
    try {
      ...
      if (withLocaleBasedPublishing) {
        config.headers = Object.assign(Object.assign({}, config.headers), { "X-Contentful-Locale-Based-Publishing": true });
      }
  ...
  async function makeGetAssets(query, options2 = {
    ...
    return internalGetAssets(localeSpecificQuery, options2);
  }
  async function internalGetAsset(id, query, options2) {
    const { withLocaleBasedPublishing } = options2;
    try {
      const baseConfig = createRequestConfig({
        query: prepareQuery(query)
      });
  ...
  async function makeGetAsset(id, query, options2 = {
    ...
    validateSearchParameters(query);
    const localeSpecificQuery = withAllLocales ? Object.assign(Object.assign({}, query), { locale: "*" }) : query;
    return internalGetAsset(id, localeSpecificQuery, options2);
  }
  async function internalGetAssets(query, options2) {
    const { withLocaleBasedPublishing } = options2;
    try {
      const baseConfig = createRequestConfig({
        query: prepareQuery(query)
...
function create3({ http, getGlobalOptions }, options, makeInnerClient) {
  ...
  Object.defineProperty(response, "withLocaleBasedPublishing", {
    get: () => makeInnerClient(Object.assign(Object.assign({}, options), { withLocaleBasedPublishing: true }))
  });
