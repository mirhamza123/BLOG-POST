import { CPAAsset, CPAEntry, CPAMappings, CreateSourceMapParams, FieldType, GraphQLMappings, GraphQLResponse, SourceMapMetadata, WidgetId, WidgetNamespace } from './types.js';
...
export declare const isNinetailedField: (field: string) => boolean;
/**
...
export declare function encodeField(fieldType: FieldType, currentValue: any, hiddenStrings: SourceMapMetadata, target: GraphQLResponse | CPAEntry | CPAAsset, pointer: string, mappings: CPAMappings | GraphQLMappings, locale?: string): void;
