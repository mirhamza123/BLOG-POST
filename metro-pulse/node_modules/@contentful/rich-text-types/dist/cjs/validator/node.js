    ...
    _create_class(NodeAssertion, [
        {
            ...
            value: function assert(node, path) {
                ...
                if ($.object('data')) {
                    ...
                    var dataErrors = (_ref1 = (_this_validateData = (_this = this).validateData) === null || _this_validateData === void 0 ? void 0 : _this_validateData.call(_this, node.data, path.of('data'))) !== null && _ref1 !== void 0 ? _ref1 : [];
